...
const GITHUB_CONFIG = {
    username: "jaypeewhat",                     // ✅ Your GitHub username
    repository: "memory-space-images",          // ✅ Your repository name  
...
class ShapeMemorySpace {
    ...
    async uploadPhoto(file) {
        ...
        if (GITHUB_CONFIG.token === "YOUR_GITHUB_TOKEN" || 
            ...
            throw new Error('Please configure your GitHub settings in the script');
        }
